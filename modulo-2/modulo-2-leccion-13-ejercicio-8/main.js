...
//PISTA: en este caso el acumulador puede ser no sólo un número sino cualquier valor.
//Por ejemplo un objeto que sea nuestro candidato a ganador:)
...
const andTheWinnerIs = runners.reduce((winner, runner) => {
