"use strict";
//Vamos a mejorar nuestra calculadora geométrica sencilla.
...
//(multiplica la longitud del lado por el número de lados - 4)
...
//Crearemos tres instancias: una con 1 de lado, otra con 3 y otra con 7.
...
console.log(
  `El cuadrado tiene un perimetro de ${mySquare1.perimeter()}cm y un área de ${mySquare1.area()}cm2.`
);
console.log(
  `El cuadrado tiene un perimetro de ${mySquare2.perimeter()}cm y un área de ${mySquare2.area()}cm2.`
);
console.log(
  `El cuadrado tiene un perimetro de ${mySquare3.perimeter()}cm y un área de ${mySquare3.area()}cm2.`
);
